...
export function AssistantAdmin() {
  ...
  return <section aria-labelledby="assistant-operations-title" className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-6">
    <div className="flex flex-wrap items-start justify-between gap-4">
      <div><h2 id="assistant-operations-title" className="text-xl font-extrabold text-slate-900">Gascomp Assistant</h2><p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">Monitor the customer chat worker and published knowledge. Pause or resume applies immediately, independently of catalog Save.</p></div>
