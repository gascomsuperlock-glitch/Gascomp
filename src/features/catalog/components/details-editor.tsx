  ...
  return (
    <div>
      ...
      <div className="mt-7 grid gap-5 sm:grid-cols-2">
        ...
        <Field label="Page address" hint="Set when the product is created so its QR code remains active."><div className="mt-2 min-h-11 break-all rounded-xl border border-[#2c3038]/8 bg-[#f4f3ef] px-3.5 py-3 text-xs font-semibold text-[#6f797f]">/produk/{product.slug}</div></Field>
