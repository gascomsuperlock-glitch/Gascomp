...
test("manual uploads enforce MIME types, nonempty files and the 50 MB limit", () => {
  for (const type of ["video/mp4", "video/webm"]) assert.equal(videoFileError({ type, size: MAX_VIDEO_BYTES }), null);
